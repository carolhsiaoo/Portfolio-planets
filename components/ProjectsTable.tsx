    ...
    <section id="work" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8">
      <div className="max-w-6xl mx-auto">
        <div>
          ...
          <div className="hidden md:grid grid-cols-4 gap-8 lg:gap-16 py-4 md:py-5 text-xs font-medium text-gray-500 uppercase tracking-widest pl-24 pr-2 lg:pl-32 lg:pr-4">
            <div>Project</div>
            <div>Type</div>
            <div>Role</div>
            <div>Year</div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              {/* Tablet+ Table Layout */}
              <div className="hidden md:grid grid-cols-4 gap-8 lg:gap-16 py-5 md:py-7 pl-24 pr-2 lg:pl-32 lg:pr-4">
