  ...
  return (
    <section className="pt-32 sm:pt-40 md:pt-40 lg:pt-56 pb-12 sm:pb-16 md:pb-20 relative min-h-[600px] sm:min-h-[700px] md:min-h-[650px] lg:min-h-screen flex items-center justify-center overflow-visible [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden" style={{ transform: 'translateZ(0)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 h-full flex flex-col justify-center sm:justify-between gap-80 sm:gap-0 pt-24 sm:pt-32 md:pt-36 pb-12 sm:pb-20 md:pb-24">
